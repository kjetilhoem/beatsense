...
| Dynamic range | Difference between loudest and quietest passages, measured over time | Done |
...
| Feature | Description | Status |
|---------|-------------|--------|
| Separate mode from key | Report root note and mode (Major/Minor) independently, allowing mode to update without root changing | Done |
...
| Tuning reference detection | Detect whether A=440 Hz or offset (e.g., A=432 Hz, A=442 Hz) | Done |
...
| Spectral rolloff | Frequency below which N% of spectral energy is contained — darkness/brightness indicator | Done |
